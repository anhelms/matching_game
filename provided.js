let clickAudio = new Audio('audio/Tackle.wav');
let matchAudio = new Audio('audio/Recover.wav');
let winAudio = new Audio('audio/45_Ending.mp3')
let resetAudio = new Audio('audio/01_Opening (part 1).mp3')
